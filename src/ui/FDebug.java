...
public class FDebug extends javax.swing.JFrame
{
    ...
    public CEmployee DebugEmployee = null;
    
    public FDebug()
    {
        initComponents();
        DebugEmployee = Database.Instance.EmployeeRegister("FNDebug", "LNDebug", 20, "1234", "1234", 0, CPrivilege.ALL_PRIVILEGE);
    }
    ...
    private void initComponents()
    {
        ...
        jButton2.setText("test get first attendance");
        ...
        jButton3.setText("get attendance state");
        ...
        jButton4.setText("test time out");
        ...
        tbIndex.setToolTipText("");

        jButton5.setText("test get display dimensions");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tbIndex, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(FDebug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
